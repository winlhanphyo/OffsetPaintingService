            ...
            <ul class="slider-for">
              <li>
                <img
                  width="100%"
                  height="100%"
                  src="@/assets/images/products/details/Fabrix_T_Shirt_01_40091.jpg"
                  alt=""
                />
              </li>
              <li>
                <img
                  width="100%"
                  height="100%"
                  src="@/assets/images/products/details/Standard_Business_Cards_-_Promo_1200px96.jpg"
                  alt=""
                />
              </li>
              <li>
                <img
                  width="100%"
                  height="100%"
                  src="@/assets/images/products/details/Standard_Business_Cards_-_Promo_400px.jpg"
                  alt=""
                />
              </li>
              <li>
                <img
                  width="100%"
                  height="100%"
                  src="@/assets/images/products/details/Standard_Business_Cards_-_Promo_400px82.jpg"
                  alt=""
                />
              </li>
            </ul>
